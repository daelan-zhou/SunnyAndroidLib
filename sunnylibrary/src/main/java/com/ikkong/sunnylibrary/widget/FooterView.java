...
import com.ikkong.sunnylibrary.progress.CircularProgressBar;
...
public class FooterView extends LinearLayout {
    ...
    public void init(Context context) {
        ...
        this.setPadding(0,dip2px(20),0,dip2px(20));

        progressBar.setIndeterminate(true);
        LayoutParams progressBarparams = new LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT);
        progressBarparams.width = progressBarparams.height = dip2px(26);
