...
public class CalendarActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cad_calendar);
    ...
    private void enterNextMonth(int gvFlag) {
        ...
        flipper.setInAnimation(AnimationUtils.loadAnimation(this, R.anim.cad_left_in));
        flipper.setOutAnimation(AnimationUtils.loadAnimation(this, R.anim.cad_left_out));
        flipper.showNext();
    ...
    private void enterPrevMonth(int gvFlag) {
        ...
        flipper.setInAnimation(AnimationUtils.loadAnimation(this, R.anim.cad_right_in));
        flipper.setOutAnimation(AnimationUtils.loadAnimation(this, R.anim.cad_right_out));
