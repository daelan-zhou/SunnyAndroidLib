 ...
 * Description:
 */
public class FloatingActionButtonN extends ImageButton {
    ...
    public FloatingActionButtonN(Context context) {
        this(context, null);
    }

    public FloatingActionButtonN(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FloatingActionButtonN(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setBackgroundCompat(Drawable drawable) {
        if (hasLollipopApi()) {
            float elevation;
            if (mShadow) {
                elevation = getElevation() > 0.0f ? getElevation() : getDimension(com.melnykov.fab.R.dimen.fab_elevation_lollipop);
            } else {
                elevation = 0.0f;
            }
    ...
    private class AbsListViewScrollDetectorImpl extends AbsListViewScrollDetectorN {
    ...
    private class RecyclerViewScrollDetectorImpl extends RecyclerViewScrollDetectorN {
        private ScrollDirectionListener mScrollDirectionListener;
    ...
    private class ScrollViewScrollDetectorImpl extends ScrollViewScrollDetectorN {
        private ScrollDirectionListener mScrollDirectionListener;
