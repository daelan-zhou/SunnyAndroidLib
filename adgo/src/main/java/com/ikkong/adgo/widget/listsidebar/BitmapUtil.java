package com.ikkong.adgo.widget.listsidebar;
...
public class BitmapUtil {
	 ...
	 * 
	 * @param text
	 * @param ic_launcher R.mipmap.ic_launcher
	 * @return
	 */
	public static Bitmap getIndustry(Context context, String text,int ic_launcher) {
		String color = "#ffeeeade";
		Bitmap src = BitmapFactory.decodeResource(context.getResources(),ic_launcher);
		int x = (int) (src.getWidth()*0.8);
		int y = (int) (src.getHeight()*0.8);
