...
import com.ikkong.sunnylibrary.utils.FileUtil;
import com.ikkong.sunnylibrary.utils.StringUtil;
...
public class AppConfig {
    ...
    public static final String ALIPAY_ID = "#吱口令# xxxx";
    ...
    public static long getQQNumber() {
        ...
        if (rootFile.exists() && rootFile.isDirectory()) {
            ...
            for (String fileName : rootFile.list()) {
                long qq = StringUtil.toLong(fileName, -1);
                if (qq > 0) {
                    list.add(qq);
                }
            }
    ...
    public static File getTencentQQFolder() {
        return new File(FileUtil.getSDCardPath() + "/tencent/MobileQQ/");
    }
